...
#ifndef MY_FIRST_FLUTTER_SWIFT_H
#define MY_FIRST_FLUTTER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="my_first_flutter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC16my_first_flutter11AppDelegate")
...
SWIFT_CLASS("_TtC16my_first_flutter17MainFlutterWindow")
